...
public class InicioSistema implements ActionListener {
    ...
    public void mostrarContraseña() {
        ...
        if (frmUsuario.isEstado() == false) {
            ...
            ImageIcon imgMostrar = new ImageIcon(getClass().getResource(frmUsuario.getRuta() +"show.png"));
            ...
            ImageIcon imgOcultar = new ImageIcon(getClass().getResource(frmUsuario.getRuta() +"hide.png"));
    ...
    public void cargarFormularioPrincipal() {
        ...
        manejoGeneral.agregarImagenEscalar(principal.getDpnZonaTrabajo(), frmUsuario.getRuta() +"fondo.jpg");
